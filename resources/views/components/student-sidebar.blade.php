            ...
            <div class="px-5">
                <a href="/student-evaluation" @click="active = 'Evaluation'" :class="{'bg-blue-hover': active === 'Evaluation'}" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gold-amber hover:font-bold  flex items-center space-x-4">
                    <svg width="16" height="16" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.79211 16.8961V7.96647C1.79211 7.29777 2.12632 6.6733 2.68271 6.30237L9.68271 1.6357C10.3545 1.18784 11.2297 1.18784 11.9015 1.6357L18.9015 6.30237C19.4579 6.6733 19.7921 7.29777 19.7921 7.96647V16.8961" stroke="#EFF0FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>                        
