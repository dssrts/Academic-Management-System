...
<body class="body-css flex flex-row justify-start"
    style="background-image: url('images/PLM.png'); background-repeat: no-repeat; background-size: cover"
    x-data="{nav_open: true, align:''}" x-bind:class="nav_open ? 'justify-start' : 'justify-center'">

    <!-- Navigation Bar Division-->
    <div class="h-screen menu w-1/5  flex-col drop-shadow-[0px_0px_4px_rgba(0,0,0,0.5)] opacity-.99] "
        x-show="nav_open">
        ...
        <div class="bg-blue h-3/4 grow flex-col flex items-center opacity-[.99]">
            ...
            <button onclick="location.href='//www.plm.edu.ph'"
                class="bg-white-10 rounded-xl w-5/6 text-blue h-9 font-inter font-bold mb-4 flex flex-row justify-start items-center text-[13px]
            transition duration-100 ease-in-out  hover:bg-blue-hover hover:text-white-10 hover:font-normal hover:text-[14px] hover:opacity-95">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-home ml-4 mr-2" width="24"
            ...
            <button
                class="bg-white-10 rounded-xl w-5/6 text-blue h-9 font-inter font-bold mb-4 flex flex-row justify-start items-center text-[13px]
            transition duration-100 ease-in-out  hover:bg-blue-hover hover:text-white-10 hover:font-normal hover:text-[14px] hover:opacity-95">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-books ml-4 mr-2" width="24"
                    height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                    stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <path d="M5 8h4" />
                    <path d="M9 16h4" />
                    <path d="M13.803 4.56l2.184 -.53c.562 -.135 1.133 .19 1.282
                .732l3.695 13.418a1.02 1.02 0 0 1 -.634 1.219l-.133 .041l-2.184 .53c-.562 .135 -1.133 -.19 -1.282 
                -.732l-3.695 -13.418a1.02 1.02 0 0 1 .634 -1.219l.133 -.041z" />
                    <path d="M14 9l4 -1" />
    ...
    <div class="h-screen flex-0 menu w-[128px] flex justify-center ml-6 mr-6">
        <a x-on:click="nav_open = !nav_open; align = justify-center" href="#">
            <div class="transition duration-150 ease-in-out bg-white-10 w-16 h-16  mt-5 flex justify-center items-center rounded-lg drop-shadow-[0px_0px_3px_rgba(0,0,0,0.3)] border-0
                ...
                <img src="{{url('images/menu-icon.png')}}" class="w-6 h-5 animate-[pulse_0.15s_ease-in-out_infinite]"
    ...
    <div class="flex-0 w-[920px] flex flex-col justify-center">
        ...
        <div class="h-12 mr-7 ml-7 flex flex-row justify-start items-center mb-5">
            <img class="h-17 w-20 mr-1 my-2  animate-[pulse_0.15s_ease-in-out_infinite]"
                style="animation-iteration-count: 1" src="{{url('images/plmlogo.png')}}">
            <div class="leading-tight flex flex-col">
                <h1 class="text-[24px]  font-bold font-katibeh text-[#d5a106] animate-[pulse_0.15s_ease-in-out_infinite]"
                    style="animation-iteration-count: 1">
                    PAMANTASAN NG LUNGSOD NG MAYNILA
                </h1>
                <h2 class="text-[13px] font-inter text-black-200 animate-[pulse_0.15s_ease-in-out_infinite]"
                    style="animation-iteration-count: 1">
        ...
        <div class="h-88 flex flex-row justify-around mb-5">
            <!-- Log-in Division -->
            <div class="bg-white-10 h-80 w-5/12 mt-5 rounded-lg drop-shadow-[0_4px_4px_rgba(0,0,0,0.4)] opacity-[.98] flex flex-col animate-[pulse_0.15s_ease-in-out_infinite]"
                style="animation-iteration-count: 1">
                ...
                <div class="flex-1 -mt-3">
                    <form method="post" class="flex flex-col h-[264px] items-start pl-9 justify-evenly">
                        ...
                        <div class="">
                            ...
                            <input
                                class="shadow appearance-none border rounded h-[32px] w-72 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-gold-hover focus:border-[2px] focus:drop-shadow-[0_5px_5px_rgba(0,0,0,0.03)]"
                                id="username" name="user_id" placeholder="2021*****" required>
                        </div>

                        <!-- Password Input -->
                        <div class="">
                            <label class="inline-block font-inter  text-[13px] text-gray-700 text-sm mb-[6px]"
                                for="password">
                                Password
                            </label>
                            <input
                                class="shadow appearance-none border border-red-500 rounded h-[32px] w-72 py-2 px-3 text-gray-700 mb-0 leading-tight focus:outline-none focus:shadow-outline  focus:border-gold-hover focus:border-[2px] focus:drop-shadow-[0_5px_5px_rgba(0,0,0,0.03)]"
                        ...
                        <div class="w-full">
                            <input
                                class="bg-blue rounded-lg cursor-pointer w-72 text-white-10 h-9 font-inter font-bold 
                        ...
                        <div class="text-black-100 text-[10px] w-72 flex justify-center ">
                            <a href="{{route('reset-password.get')}}"
                                class="transition duration-150 ease-in-out hover:font-bold hover:text-blue-pressed hover:opacity-90">
            ...
            <div class="bg-white-10 h-80 w-5/12  mt-5 mb-[14px] rounded-lg flex flex-col drop-shadow-[0_3px_3px_rgba(0,0,0,0.4)] animate-[pulse_0.15s_ease-in-out_infinite]"
                style="animation-iteration-count: 1">
                ...
                <div class="bg-white-10 h-[132px] flex flex-1 flex-row">
                    ...
                    <div id="enlargedModal" class="enlarged-image">
                        ...
                        <span class="text-white-10 text-[24px] absolute top-5 right-5 cursor-pointer"
                            onclick="hideEnlargedImage()">&times;</span>
                    ...
                    <div class="class = bg-white-10 w-1/2 flex flex-col justify-center pt-10 pb-8 mt-4">
                        ...
                        <span class="font-inter text-[11px] leading-[12px] text-blue-hover">Academic year
                            2023-2024</span>
                        <span class="font-inter font-bold leading-[20px] text-[12px] text-gold">SEMESTER</span>
                        <a onclick="showEnlargedImage('{{ url('images/calendar.png') }}')"
                            class="cursor-pointer font-inter text-blue leading-[30px] text-[10px] underline hover:font-bold">
                            Click here to enlarge image </a>
                    </div>
                </div>
                ...
                <div class="bg-white-10 h-[132px] flex flex-row pb-6 pl-1 rounded-bl-lg rounded-br-lg ">
                    ...
                    <div
                        class="class = bg-white-10 w-1/2 flex flex-col justify-center pt-10 pb-10 rounded-bl-lg rounded-br-lg">
                        <span class="font-inter font-bold text-blue italic">University Calendar</span>
                        <span class="font-inter text-[11px] leading-[12px] text-blue-hover">Academic year
                            2023-2024</span>
        ...
        <div class=" flex-none flex flex-col justify-center">
            ...
            <div class="ml-7 mr-7 text-blue-hover font-extrabold text-[24px] italic"
                style="-webkit-text-stroke: 1px rgba(255,255,255,0.6); ">
                Announcement & Events
            </div>
            <!-- Announcement 10x2 Banner Image -->
            <div
                class=" cursor-pointer h-[157px] w-[855px] bg-white-10 mt-[12px] ml-7 mr-7 rounded-lg drop-shadow-[0_3px_3px_rgba(0,0,0,0.4)] opacity-100 hover:bg-black-300">
                <a class="text-opacity-0 text-white-10 hover:text-opacity-100 ">
                    <img src="{{url('images/banner.png')}}"
                        class="object-fill h-[157px] w-[855px] rounded-lg opacity-[0.98] hover:opacity-50 animate-[pulse_0.15s_ease-in-out_infinite]"
                        style="animation-iteration-count: 1">
