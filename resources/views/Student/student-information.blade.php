                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 max-w-4xl mx-auto">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-lg flex flex-col justify-between h-48">
                            ...
                            <div class="relative bg-cover bg-center h-28 w-full mt-1 rounded-lg" style="background-image: url('images/card-image.png');">
                                <div class="absolute top-0 left-0 w-full h-full flex items-center justify-start pl-4 text-[24px] font-bold text-white-10">1.23 G.W.A</div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-lg flex flex-col justify-between h-48">
                            ...
                            <div class="relative bg-cover bg-center h-28 w-full mt-1 rounded-lg" style="background-image: url('images/card-image.png');">
                                <div class="absolute top-0 left-0 w-full h-full flex items-center justify-start pl-4 text-[24px] font-bold text-white-10">Regular</div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-lg flex flex-col justify-between h-48">
                            ...
                            <div class="grid grid-cols-2 gap-2 text-sm">
                                ...
                                <div class="flex items-center col-span-2  text-[12px]">
