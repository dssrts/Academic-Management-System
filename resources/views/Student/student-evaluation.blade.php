...
<body class="bg-opacity-80" style="background-image: url('images/PLM.png'); background-size: cover; font-family: 'Inter', sans-serif;">
    <div class="flex flex-col h-screen font-inter">
        ...
        <div class="flex flex-1 overflow-hidden font-inter">
            ...
            <!-- Main content -->
            <div class="flex-1 p-10 overflow-hidden" x-data="{ status: 'completed' }"> <!-- Using Alpine.js for status -->
                <div class="flex flex-col space-y-4">
                    <div class="flex justify-between items-start">
                        <!-- Status Card -->
                        <div class="bg-white p-4 rounded-lg shadow-md flex items-center justify-between w-1/4">
                            <div>
                                <h2 class="text-blue font-bold text-[18px]">SFE Status</h2>
                                <p class="text-black-300 text-[14px] ">1st SEM - AY 2023-2024</p>
                                <div class="relative text-white w-48 h-16 py-2 px-4 rounded-lg flex items-center justify-start mt-2">
                                    ...
                                    <span class="relative z-10 text-[18px] font-bold" x-text="status.charAt(0).toUpperCase() + status.slice(1)"></span>
                                </div>
                            </div>
                        </div>
                        <button class="bg-blue font-bold hover:bg-blue-hover text-white text-[16px] py-2 px-4 rounded-lg mt-28">
                            PLM SFE
                        </button>
                    ...
                    <div class="bg-white rounded-lg shadow-md">
                        <div class="flex items-center justify-center bg-blue text-white p-4 rounded-t-lg">
                            <h2 class="font-bold text-[18px]">Status of SFE per Course</h2>
                        </div>
