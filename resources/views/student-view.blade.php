            ...
            <div class = "flex-1 flex flex-row justify-center items-center rounded-xl ">
                <div x-show="btns.dashboard"
                    ...
                    <div class="bg-white-10 rounded-2xl drop-shadow-[0_5px_5px_rgba(0,0,0,0.03)] flex flex-col">
                        ...
                        <div class="h-full flex justify-center items-center p-4">
                            <h1 class="font-bold font-inter text-[16px] {{ $students->registration_status == 'Unenrolled' ? 'text-red' : 'text-green-bright' }}">
                    ...
                    <div class="bg-white-10 rounded-2xl drop-shadow-[0_5px_5px_rgba(0,0,0,0.03)] flex flex-col">
                        ...
                        <div class="h-full flex justify-center items-center p-4">
                            <h1 class="font-bold font-inter text-[16px]">
                                ...
                                $color = ($selectedPhrase == 'Not answered yet') ? 'red' : 'limegreen';
                                ?>
                        ...
                        <form action ="{{ route('student-view.post-request', ['id' => $students->student_no]) }}"
                            ...
                            <div class="mb-4 justify-center flex">
                                ...
                                <p class="font-inter mt-1 mr-8 text-sm text-gray-500 dark:text-gray-200"
                                    id="file_input_help">.pdf (max 5 mb)</p>
                                <input type="submit"
                ...
                <div x-show="btns.inbox"
                    class="container mx-auto bg-blue font-inter bg-opacity-95 shadow-xl rounded-xl text-[13px]">
                    <div class="bg-white p-6 rounded-lg shadow-md h-96 w-full overflow-auto">
                        <div class="mb-4">
                            <h2 class="text-[20px] font-bold text-center text-white-10 font-inter italic">STUDENT INBOX
                            </h2>
                            <input type="text" id="searchInput" placeholder="Search by subject..."
                                class="mb-1 mt-2 px-4 py-2 w-full rounded-xl border-1
                             border-blue focus:outline-none focus:border-blue-500 transition-colors">
                        </div>
                        <div class="space-y-4">
                            @foreach ($appeals as $appeal)
                                <div class="p-4 rounded-lg bg-white-10 shadow-xl cursor-pointer appeal-item {{ empty($appeal->remarks) ? 'opacity-80' : 'opacity-100' }}"
