...
<div {{ $attributes->class([
    ...
    <nav
        ...
        <x-filament::icon-button color="gray" icon="heroicon-o-bars-3" icon-alias="panels::topbar.open-sidebar-button"
            ...
            x-on:click="$store.sidebar.open()" x-show="! $store.sidebar.isOpen" @class([ 'lg:hidden'=> (!
            ...
            <x-filament::icon-button color="gray" icon="heroicon-o-x-mark"
                ...
                x-on:click="$store.sidebar.close()" x-show="$store.sidebar.isOpen" class="lg:hidden" />
            ...
            @endif
            @endif
            <img src="/images/plm-header.png" alt="plm header" style="height:3rem">
