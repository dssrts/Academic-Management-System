...
>
    ...
    <p class="place-self-center text-white"><b>Admin!</b></p>
    @endif
    @if ($user->hasRole("student"))
    <p class="place-self-center text-white"><b>Student CRS</b></p>
    @endif
    @if ($user->hasRole("dean_crs")||$user->hasRole("dean_crs"))
    <p class="place-self-center text-white"><b>Dean Portal</b></p>
    @endif
    @if ($user->hasRole("dean_gsp")||$user->hasRole("dean_crs"))
    <p class="place-self-center text-white"><b>Dean Portal</b></p>
    @endif --}}
    
    @if ($user->hasRole('admin'))
    <x-filament::avatar class="place-self-center"
    src="/images/user.png"
    alt="User Avatar"
    size="w-20 h-20"
    />
    <div class="bg-white flex flex-col items-center text-plm-blue justify-center rounded-md py-2">
        <p class="text-center font-inter text-[14px]" >Welcome, <b> Admin!</b></p>
        <b class="text-yellow text-center font-inter text-[14px]">Academic Management <br> System</b> 
       </div>   
    @else
    <x-filament::avatar class="place-self-center"
    src="/images/user.png"
    ...
    />
    <div class="bg-white flex flex-col items-center text-plm-blue justify-center rounded-md py-2">
     <p class="text-center font-inter text-[14px]" >Welcome, <b>  {{ filament()->getUserName($user) }}!</b></p>
     <b class="text-yellow text-center font-inter text-[14px]"> {{ $user->department->title }}</b> 
    </div>
    ...
    @endif
        ...
        @if (filament()->hasNavigation())
            <ul class="-mx-2 flex flex-col gap-y-0">
...
<x-filament::button
    href="/ams/students/view-information"
    tag="a"
>
    View Information
</x-filament::button>
