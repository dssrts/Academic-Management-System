...
>
    <a
        ...
        @endif
        @class([
            'fi-sidebar-item-button relative flex items-center justify-center gap-x-3 rounded-lg px-2 py-2 text-sm outline-none transition duration-75 hover:bg-yellow focus-visible:bg-gray-100 dark:hover:bg-white/5 dark:focus-visible:bg-white/5',
    ...
    >
        ...
        <span
            ...
            @class([
                ...
                'text-plm-blue dark:text-plm-blue' => $active,
            ])
        >
            {{ $slot }}
        </span>
